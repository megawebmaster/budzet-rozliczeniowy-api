 ...
 */
class Version20180423202318 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE budget ADD slug VARCHAR(50) NOT NULL DEFAULT ''");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER SEQUENCE budget_year_id_seq INCREMENT BY 1');
        $this->addSql('ALTER SEQUENCE budget_entry_id_seq INCREMENT BY 1');
        $this->addSql('ALTER TABLE budget DROP slug');
    }
}
